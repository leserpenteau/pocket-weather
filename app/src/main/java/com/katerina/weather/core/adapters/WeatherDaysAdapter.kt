...
class WeatherDaysAdapter() :
    ...
    class Holder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: WeeklyForecastModel) = with(binding) {
            ...
            when (item.condition) {
                "Sunny" -> {
                    imgDay.setBackgroundResource(R.drawable.img_sunny)
                }
                "Clear" -> {
                    imgDay.setBackgroundResource(R.drawable.img_sunny)
                }
                "Partly cloudy" -> {
                    imgDay.setBackgroundResource(R.drawable.img_partly_cloudy)
                }
                "Cloudy" -> {
                    imgDay.setBackgroundResource(R.drawable.img_cloudy)
                }
                "Overcast" -> {
                    imgDay.setBackgroundResource(R.drawable.img_cloudy)
                }
                "Patchy rain possible" -> {
                    imgDay.setBackgroundResource(R.drawable.img_rainy)
                }
                "Mist" -> {
                    imgDay.setBackgroundResource(R.drawable.img_mist)
                }
                "Patchy snow possible" -> {
                    imgDay.setBackgroundResource(R.drawable.img_snow)
                }
                ...
                "Thundery outbreaks possible" -> {
                    imgDay.setBackgroundResource(R.drawable.img_thunderstorm)
                }
                "Blizzard" -> {
                    imgDay.setBackgroundResource(R.drawable.img_snow)
                }
    ...
    class Comparator : DiffUtil.ItemCallback<WeeklyForecastModel>() {
        ...
        override fun areItemsTheSame(
            oldItem: WeeklyForecastModel,
            newItem: WeeklyForecastModel
        ): Boolean {
